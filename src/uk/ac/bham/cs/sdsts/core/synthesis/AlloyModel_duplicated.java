...
public class AlloyModel_duplicated {
...
//			this.addSig(newSig2);
//			
//			// make the events to lone
//			PrimSig newSig2SendEvent = new PrimSig(sig2_send_event.label, sig2_send_event.parent, Attr.LONE);
//			this._mapping_sigs.values().remove(sig2_send_event);
//			this.addSig(newSig2SendEvent);
//			PrimSig newSig2RecEvent = new PrimSig(sig2_rec_event.label, sig2_rec_event.parent, Attr.LONE);
//			this._mapping_sigs.values().remove(sig2_rec_event);
//			this.addSig(newSig2RecEvent);
//			this.addFact(String.format("# %s = 0", newSig2SendEvent));
//			this.addFact(String.format("# %s = 0", newSig2RecEvent));
//			Object thing = sig2_send_event.getFacts();
//			
//			
//			// add the fact
//			// add fact
